///Script de teste que deve criar um novo usuário que não esteja cadastrado no E-commerce DSJ
...
describe('Tela Cadastro de Usuário', () => {
    ...
    it('Validação de Usuário ja Cadastrado', () => {
            cy.visit('https://homolog-shop-ecommerce.szsolucoes.com.br/'); 
            cy.get('.justify-center > .text-base').click();
            cy.wait(2000);
            cy.get('div.text-sm > a').click();
    ...
    it('Validação do Formato de E-mail', () => {
        cy.visit('https://homolog-shop-ecommerce.szsolucoes.com.br/'); 
        cy.get('.justify-center > .text-base').click();
      // Criar conta
        cy.wait(2000);
